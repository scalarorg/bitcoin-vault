use crate::{hex_to_vec, BUILD_USER_PROTOCOL_SPEND_PARAMS, MANAGER, MOCK_ENV, TEST_PSBT_HEX};
...
fn test_sign_psbt() {
    ...
    let _ = MANAGER
        .sign_psbt_by_single_key(&mut psbt, &PRIVKEY_BYTES, NetworkKind::Test, false)
        .unwrap();
    ...
    let _ = MANAGER
        .sign_psbt_by_single_key(&mut psbt, &PROTOCOL_PRIVKEY_BYTES, NetworkKind::Test, true)
        .unwrap();
    ...
    assert_eq!(EXPECTED_TX_HEX, tx_hex);
}
