...
fn test_sign_psbt_by_protocol() {
    let psbt_hex = "".to_string();

    let psbt_slice = hex_to_vec!(psbt_hex);

    let mut psbt = Psbt::deserialize(&psbt_slice).unwrap();

    println!("PSBT Input count: {}", psbt.inputs.len());
    println!(
        "Input 0 tap_script_sigs count: {}",
        psbt.inputs[0].tap_script_sigs.len()
    );

    // Print all tap_script_sigs keys
    for ((pubkey, leaf_hash), sig) in psbt.inputs[0].tap_script_sigs.iter() {
        println!("Signature for pubkey: {}", pubkey);
