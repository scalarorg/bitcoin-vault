...
const TEST_CUSTODIAL_QUORUM: u8 = 1;
const TEST_HAVE_ONLY_COVENANTS: bool = false;
const TEST_RBF: bool = true;
const TEST_UTXO_AMOUNT: u64 = 10_000;
const TEST_FEE_AMOUNT: u64 = 1000;
const TEST_UTXO_VOUT: u32 = 0;
const TEST_VERSION: u8 = 0;
const TEST_TAG: [u8; 4] = [1, 2, 3, 4];

static MOCK_ENV: LazyLock<Env> = LazyLock::new(|| {
...
fn test_build_user_protocol_spend() {
    ...
    let manager = StakingManager::new(TEST_TAG.to_vec(), TEST_VERSION);

    let psbt = manager.build_user_protocol_spend(&params).unwrap();
    let psbt_hex = psbt.serialize_hex();
    assert_eq!("", psbt_hex);
}
...
fn load_build_user_protocol_spend_params() -> BuildUserProtocolSpendParams {
    ...
    assert_eq!(
        p2wpkh_script.to_hex_string(),
        "0014acd07b22adf2299c56909c9ca537fd2c58127ecc"
    );
