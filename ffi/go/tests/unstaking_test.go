...
// CGO_LDFLAGS="-L./lib -lbitcoin_vault_ffi" CGO_CFLAGS="-I./lib" go test -timeout 30s -run ^TestEncodePoolingRedeemParams$ github.com/scalarorg/bitcoin-vault/ffi/go/tests
...
// CGO_LDFLAGS="-L./lib -lbitcoin_vault_ffi" CGO_CFLAGS="-I./lib" go test -timeout 30s -run ^TestEncodePoolingRedeemParamsV33$ github.com/scalarorg/bitcoin-vault/ffi/go/tests
